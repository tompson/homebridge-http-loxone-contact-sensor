...
module.exports = function (homebridge) {
    ...
    homebridge.registerAccessory("homebridge-http-contact-sensor", "LoxoneContactSensor", ContactSensorAccessory);
};
...
ContactSensorAccessory.prototype = {
    ...
    isDoorClosed: function (callback) {
        if (this.statusUrl != null) {
            http.get(this.statusUrl, (resp) => {
                ...
                resp.on('end', () => {
                    callback(JSON.parse(data).LL.value == 0);
                });
            }).on("error", (err) => {
    ...
    getServices: function () {
        ...
        informationService
            ...
            .setCharacteristic(Characteristic.Model, "Magnet contact")
